...
public class CoverageOverviewDialogPresenterImpl extends PresenterBase<CoverageOverviewDialogPresenter.Display> implements CoverageOverviewDialogPresenter {

	private CoverageDescription selectedCoverage;

	public CoverageOverviewDialogPresenterImpl(EventBus eventBus, CoverageOverviewDialogPresenter.Display display) {
